...
if uploaded_file is not None:
    try:
        ...
        # CÁLCULO Y DISPLAY DE KPIs (Métricas)
        ...
        st.header("Resumen Ejecutivo de Auditoría")
        ...
        if not desvios.empty:
            ...
            # VISUALIZACIÓN DE RIESGOS (Gráfico de Barras)
            ...
            st.subheader("🔴 Detalle de las Desviaciones Encontradas")
